...
<grid:grid id="bedRoomGridId" url="${adminPath}/room/bedroom/ajaxList">
    ...
    <grid:column label="房间编号"  name="roomNoText"  query="true"  queryMode="input"  condition="like" />
    ...
    <grid:column label="护理类别"  name="nursingType"  query="true"  queryMode="select"  condition="eq"  dict="nursing_type"/>
