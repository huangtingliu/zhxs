package cn.zhxs.core.query.resolver;
...
import cn.zhxs.core.mapper.MapWapper;
import cn.zhxs.core.query.annotation.RequestJsonParam;
			...
			if (paramValues.length == 1) {
				...
				if (MapWapper.class.isAssignableFrom(paramType)) {
					...
					if (type instanceof ParameterizedType) {
						...
						mapType = (MapType) mapType
								.narrowContentsBy((Class<?>) ((ParameterizedType) type).getActualTypeArguments()[1]);
					}
