...
import cn.zhxs.core.disruptor.sms.SmsEvent.SmsHandlerCallBack;
import cn.zhxs.core.disruptor.sms.SmsHelper;
import cn.zhxs.core.utils.SpringContextHolder;
import cn.zhxs.core.utils.sms.data.SmsResult;
import cn.zhxs.modules.sms.entity.SmsTemplate;
import cn.zhxs.modules.sms.service.ISmsSendService;
import cn.zhxs.modules.sms.service.ISmsTemplateService;
...
public class SmsSendServiceImpl implements ISmsSendService {
	...
	public void sendAsyncSmsByCode(String phone, String code, SmsHandlerCallBack callBack, String... datas) {
		...
		cn.zhxs.core.utils.sms.data.SmsTemplate template = cn.zhxs.core.utils.sms.data.SmsTemplate.newTemplate(templateId, templateContent);
	...
	public void sendAsyncSmsByContent(String phone, String content, SmsHandlerCallBack callBack, String... datas) {
		cn.zhxs.core.utils.sms.data.SmsTemplate template = cn.zhxs.core.utils.sms.data.SmsTemplate.newTemplateByContent(content);
		SpringContextHolder.getBean(SmsHelper.class).sendAsyncSms(phone, template, callBack, datas);
	}
