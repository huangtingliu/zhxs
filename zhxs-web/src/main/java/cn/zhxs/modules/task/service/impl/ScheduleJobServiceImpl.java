package cn.zhxs.modules.task.service.impl;

import cn.zhxs.core.common.service.impl.CommonServiceImpl;
import cn.zhxs.core.quartz.QuartzManager;
import cn.zhxs.modules.task.entity.ScheduleJob;
import cn.zhxs.modules.task.mapper.ScheduleJobMapper;
import cn.zhxs.modules.task.service.IScheduleJobService;
import cn.zhxs.modules.task.utils.ScheduleJobUtils;
...
public class ScheduleJobServiceImpl extends CommonServiceImpl<ScheduleJobMapper, ScheduleJob>
	...
	public void updateCron(String jobId) throws SchedulerException {
		...
		if (cn.zhxs.core.quartz.data.ScheduleJob.STATUS_RUNNING.equals(scheduleJob.getJobStatus())) {
	...
	public void changeStatus(String jobId, String cmd) throws SchedulerException {
		...
		if ("stop".equals(cmd)) {
			...
			scheduleJob.setJobStatus(cn.zhxs.core.quartz.data.ScheduleJob.STATUS_NOT_RUNNING);
		} else if ("start".equals(cmd)) {
			scheduleJob.setJobStatus(cn.zhxs.core.quartz.data.ScheduleJob.STATUS_RUNNING);
